...
/*
 * Build hexagonal tile geometry skeleton (no connections)
 */
struct geometry*
build_hex_tile_skeleton(const struct gameinfo *info)
{
	struct geometry *geo;
	int i, j;
	int dimx;
...
/*
 * Build hexagonal tile geometry data
 */
struct geometry*
